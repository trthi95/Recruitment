						...
						<div class="ibox ">
							...
							<div class="ibox-content">
								<form action="" method="post">
									<div class="form-group">
										<label>Position</label><br> <select name="positionName" class="form-control" required>
											<c:forEach var="position" items="${listPosition }">
												<option>${position.getPositionName() }</option>
											</c:forEach>
										</select>
									...
									<div class="form-group">
										<label>Number Opening</label> <input type="number"
											name="numberOpening" class="form-control" required>
									</div>
									<div class="form-group">
										<label>Department</label> <select name="departmentName" class="form-control" required>
											<c:forEach var="department" items="${listDepartment }">
												<option>${department.getDepartmentName() }</option>
											</c:forEach>
										</select>
									...
									<div class="form-group">
										<label>Description</label> <input id="" type="text" name="description" class="form-control" required/>
									</div>
									<div class="form-group">
										<label>Requirement</label><br>
										<input id="" type="text" name="requirement" class="form-control" required/>

									</div>
									<div class="form-group">
										<label>Offer</label> <input id="" type="text" name="offer"class="form-control" required />
									</div>
									<div class="form-group">
										<label>Experience</label> <input id="" type="number" name="experience" class="form-control" required/>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input id="" type="text" name="degree" class="form-control" required/>
									</div>
									<div>
