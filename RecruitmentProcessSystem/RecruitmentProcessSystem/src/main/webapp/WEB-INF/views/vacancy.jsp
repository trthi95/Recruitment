...
<%-- 	<table>
		...
		<c:forEach var="vacancy" items="${listVacancy}">
			<tr>
				<td><a href="applicantVacancy/${vacancy.getVacancyNumber()}">
						${vacancy.getVacancyNumber()}</a>
				...
				<td><form action="" method="post">
						<input type="hidden" value="${vacancy.getIdVacancy()}"
							name="idVacancy">${vacancy.getIdVacancy()} <input
								...
								<table class="footable table table-stripped toggle-arrow-tiny">
									<thead>
										<tr>
											...
											<th data-toggle="true">Vacancy Number</th>
											<th>Date created</th>
											<th>Date close</th>
									...
									<tbody>
										<c:forEach var="vacancy" items="${listVacancy}">
											<tr>
												<td><a
													href="applicantVacancy/${vacancy.getVacancyNumber()}">
														${vacancy.getVacancyNumber()}</a></td>
												<td>${vacancy.getDateCreated() }</td>
												<td>${vacancy.getDateClose() }</td>
												<td>${vacancy.getUser().getFullName() }</td>
												<td>${vacancy.getState() }</td>
												<td>${vacancy.getPosition().getPositionName() }</td>
												<td>${vacancy.getDescription() }</td>
												<td>${vacancy.getDepartment().getDepartmentName() }</td>
												<td>${vacancy.getRequirement() }</td>
												<td>${vacancy.getOffer() }</td>
												<td>${vacancy.getDegree() }</td>
												<td><form action="" method="post">
														<input type="hidden" value="${vacancy.getIdVacancy()}"
															name="idVacancy"> <input type="submit" /> <input
