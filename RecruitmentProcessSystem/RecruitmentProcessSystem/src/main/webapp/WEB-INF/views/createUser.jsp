			...
			<div class="sidebar-collapse">
				<ul class="nav metismenu" id="side-menu">
					...
					<li><form
							...
							method="post">
							<input type="hidden" class="fa fa-diamond nav-label"
								name="${_csrf.parameterName}" value="${_csrf.token}" /> <input
								type="submit" class="fa fa-diamond nav-label" value="Logout">
						</form> <i class="fa fa-diamond"></i> <span class="nav-label"></span></li>
					...
					<div class="col-lg-6">
						<div class="ibox ">
							...
							<div class="ibox-content">
									...
									<div class="form-group">
										<label>Position</label> <select id="positionName" name="positionName" required>
									...
									<div class="form-group">
										<label>Department</label><br> <select id="departmentName" required
											name="departmentName">
									...
									<div class="form-group">
										<label>Role</label> <select id="roleName" name="role" required>
									...
									<input type="hidden" name="${_csrf.parameterName}"
										value="${_csrf.token}" />
										<button id="btn-create-user" class="btn btn-sm btn-primary m-t-n-xs" type="submit">
											<strong>Submit</strong>
										</button><br><span id="noticed-admin"></span>
									</div>
									<input type="hidden" name="${_csrf.parameterName}"
										value="${_csrf.token}" />
							</div>
